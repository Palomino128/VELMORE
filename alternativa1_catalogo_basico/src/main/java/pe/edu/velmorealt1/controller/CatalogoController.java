package pe.edu.velmorealt1.controller;
import pe.edu.velmorealt1.dto.BusquedaProductoDto;
import pe.edu.velmorealt1.dto.ContactoDto;
import pe.edu.velmorealt1.model.Categoria;
import pe.edu.velmorealt1.service.ContactoService;
import pe.edu.velmorealt1.service.ProductoService;
...
public class CatalogoController {
    ...
    @GetMapping("/") public String inicio(Model model) {
        model.addAttribute("titulo","Alternativa 1: Sistema Web de Catálogo Básico");
